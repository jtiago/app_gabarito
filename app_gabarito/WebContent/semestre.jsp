...
<div id="tudo">
	...
	<div id="menu_cadastro">
		<ul class="lavaLampBottomStyle" id="3">
            <li><a href="manter_semestre.jsp?acao=cadastrar" target="turma">Cadastrar</a></li>
            <li><a href="manter_semestre.jsp?acao=alterar" target="turma">Alterar</a></li>
            <li><a href="manter_semestre.jsp?acao=excluir" target="turma">Excluir</a></li>
    	</ul>
	</div>

	<div id="iframe">
		<iframe width="780" onload='iframeAutoHeight(this)' frameborder="0" 
			scrolling="auto" name="turma" src="manter_semestre.jsp?acao=cadastrar"></iframe>
	</div>
